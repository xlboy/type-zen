...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "e_mainWithoutUnion", "symbols": ["s_sugarBlock"], "postprocess": id},
    ...
    {"name": "s_enum_member_eof$subexpression$1", "symbols": [{"literal":","}]},
    {"name": "s_enum_member_eof$subexpression$1", "symbols": [{"literal":";"}]},
    {"name": "s_enum_member_eof", "symbols": ["s_enum_member_eof$subexpression$1", "_"], "postprocess": n},
    {"name": "s_sugarBlock", "symbols": [{"literal":"^"}, "_", "s_sugarBlock_content"], "postprocess": args => args.at(-1)},
    {"name": "s_sugarBlock_content$ebnf$1$subexpression$1", "symbols": ["s_sugarBlock_content_block", "blockSeparator"]},
    {"name": "s_sugarBlock_content$ebnf$1", "symbols": ["s_sugarBlock_content$ebnf$1$subexpression$1"]},
    {"name": "s_sugarBlock_content$ebnf$1$subexpression$2", "symbols": ["s_sugarBlock_content_block", "blockSeparator"]},
    {"name": "s_sugarBlock_content$ebnf$1", "symbols": ["s_sugarBlock_content$ebnf$1", "s_sugarBlock_content$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_sugarBlock_content", "symbols": [{"literal":"{"}, "_", "s_sugarBlock_content$ebnf$1", {"literal":"}"}], "postprocess": args => toASTNode(ast.SugarBlockStatement)([args[0], args[2].map(id), args.at(-1)])},
    {"name": "s_sugarBlock_content_block", "symbols": ["s_typeAlias"], "postprocess": id},
    {"name": "s_sugarBlock_content_block", "symbols": ["s_if"], "postprocess": id},
    {"name": "s_sugarBlock_content_block", "symbols": ["s_return"], "postprocess": id},
    {"name": "s_if", "symbols": [{"literal":"if"}, "_", {"literal":"("}, "s_if_condition", {"literal":")"}, "_", "s_sugarBlock_content"], "postprocess": args => toASTNode(ast.IfStatement)([args[0], args[3], args.at(-1)])},
    {"name": "s_if", "symbols": [{"literal":"if"}, "_", {"literal":"("}, "s_if_condition", {"literal":")"}, "_", "s_sugarBlock_content", "_", {"literal":"else"}, "_", "s_sugarBlock_content"], "postprocess": args => toASTNode(ast.IfStatement)([args[0], args[3], args[6], args.at(-1)])},
    {"name": "s_if$ebnf$1", "symbols": ["nonEmptySpace"]},
    {"name": "s_if$ebnf$1", "symbols": ["s_if$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_if", "symbols": [{"literal":"if"}, "_", {"literal":"("}, "s_if_condition", {"literal":")"}, "_", "s_sugarBlock_content", "_", {"literal":"else"}, "s_if$ebnf$1", "s_if"], "postprocess": args => toASTNode(ast.IfStatement)([args[0], args[3], args[6], args.at(-1)])},
    {"name": "s_if_condition", "symbols": ["e_main", "e_condition_extend", "e_main"], "postprocess": args => ({ left: args[0], right: args.at(-1) })},
    {"name": "s_return$ebnf$1", "symbols": ["nonEmptySpace"]},
    {"name": "s_return$ebnf$1", "symbols": ["s_return$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_return", "symbols": [{"literal":"return"}, "s_return$ebnf$1", "e_main"], "postprocess": args => toASTNode(ast.ReturnStatement)([args[0], args.at(-1)])},
