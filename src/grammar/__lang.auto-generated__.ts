...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "e_function_regular", "symbols": ["e_function_body", "_", {"literal":":"}, "_", "e_function_return"], "postprocess": args => toASTNode(ast.Function.Mode.NormalExpression)([args[0], args.at(-1)])},
    {"name": "e_function_regular", "symbols": ["e_function_genericArgs", "_", "e_function_body", "_", {"literal":":"}, "_", "e_function_return"], "postprocess": args => toASTNode(ast.Function.Mode.NormalExpression)([args[0], args[2], args.at(-1)])},
