...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "e_function_regular", "symbols": ["e_function_body", "_", {"literal":":"}, "_", "e_function_return"], "postprocess": args => toASTNode(ast.Function.Mode.RegularExpression)([args[0], args.at(-1)])},
    {"name": "e_function_regular", "symbols": ["e_function_genericArgs", "_", "e_function_body", "_", {"literal":":"}, "_", "e_function_return"], "postprocess": args => toASTNode(ast.Function.Mode.RegularExpression)([args[0], args[2], args.at(-1)])},
    ...
    {"name": "e_object_content", "symbols": ["e_object_content_callExpression"], "postprocess": id},
    {"name": "e_object_content", "symbols": ["e_object_content_constructorExpression"], "postprocess": id},
    ...
    {"name": "e_object_content_callExpression", "symbols": ["e_function_regular"], "postprocess": id},
    {"name": "e_object_content_constructorExpression$macrocall$2", "symbols": ["e_function_regular"], "postprocess": id},
    {"name": "e_object_content_constructorExpression$macrocall$1$ebnf$1", "symbols": ["nonEmptySpace"]},
    {"name": "e_object_content_constructorExpression$macrocall$1$ebnf$1", "symbols": ["e_object_content_constructorExpression$macrocall$1$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_object_content_constructorExpression$macrocall$1", "symbols": [{"literal":"new"}, "e_object_content_constructorExpression$macrocall$1$ebnf$1", "e_object_content_constructorExpression$macrocall$2"], "postprocess": args => toASTNode(ast.Function.Mode.ConstructorExpression)([args[0], args.at(-1)])},
    {"name": "e_object_content_constructorExpression", "symbols": ["e_object_content_constructorExpression$macrocall$1"], "postprocess": id},
    ...
    {"name": "e_object_content_method", "symbols": ["e_object_content_method_key", "_", "e_object_content_method$ebnf$1", "_", "e_function_regular"], "postprocess":  args => toASTNode(ast.Object.Content.MethodExpression)([
        args[0], 
        !!args[2], args.at(-1)
        ]) 
            },
