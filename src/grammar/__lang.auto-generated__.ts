...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "e_tuple_value", "symbols": ["e_main", "_", "e_tuple_value$ebnf$1"], "postprocess": args => ({ id: false, deconstruction: false, type: args[0], optional: !!args.at(-1) })},
    {"name": "e_tuple_value", "symbols": [{"literal":"..."}, "e_main"], "postprocess": args => ({ id: false, deconstruction: true, type: args[1], optional: false })},
    {"name": "e_tuple_value$ebnf$2", "symbols": [{"literal":"?"}], "postprocess": id},
    {"name": "e_tuple_value$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "e_tuple_value", "symbols": ["id", "_", "e_tuple_value$ebnf$2", "_", {"literal":":"}, "_", "e_main"], "postprocess": args => ({ id: args[0], deconstruction: false, type: args.at(-1), optional: !!args[2] })},
