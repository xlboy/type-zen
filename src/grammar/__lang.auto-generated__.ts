...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "e_sugarBlock", "symbols": [{"literal":"^"}, "_", "e_sugarBlock_content"], "postprocess": args => args.at(-1)},
    {"name": "e_sugarBlock_content$ebnf$1$subexpression$1", "symbols": ["e_sugarBlock_content_block", "blockSeparator"]},
    {"name": "e_sugarBlock_content$ebnf$1", "symbols": ["e_sugarBlock_content$ebnf$1$subexpression$1"]},
    {"name": "e_sugarBlock_content$ebnf$1$subexpression$2", "symbols": ["e_sugarBlock_content_block", "blockSeparator"]},
    {"name": "e_sugarBlock_content$ebnf$1", "symbols": ["e_sugarBlock_content$ebnf$1", "e_sugarBlock_content$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_sugarBlock_content", "symbols": [{"literal":"{"}, "_", "e_sugarBlock_content$ebnf$1", {"literal":"}"}], "postprocess": args => toASTNode(ast.SugarBlockExpression)([args[0], args[2].map(id), args.at(-1)])},
    ...
    {"name": "e_sugarBlock_content_block", "symbols": ["e_sugarBlock_return"], "postprocess": id},
    {"name": "e_sugarBlock_content_block", "symbols": ["e_sugarBlock_for"], "postprocess": id},
    {"name": "e_sugarBlock_if", "symbols": [{"literal":"if"}, "_", {"literal":"("}, "e_sugarBlock_if_condition", {"literal":")"}, "_", "e_sugarBlock_content"], "postprocess": args => toASTNode(ast.SugarBlockIfExpression)([args[0], args[3], args.at(-1)])},
    {"name": "e_sugarBlock_if", "symbols": [{"literal":"if"}, "_", {"literal":"("}, "e_sugarBlock_if_condition", {"literal":")"}, "_", "e_sugarBlock_content", "_", {"literal":"else"}, "_", "e_sugarBlock_content"], "postprocess": args => toASTNode(ast.SugarBlockIfExpression)([args[0], args[3], args[6], args.at(-1)])},
    {"name": "e_sugarBlock_if$ebnf$1", "symbols": ["nonEmptySpace"]},
    {"name": "e_sugarBlock_if$ebnf$1", "symbols": ["e_sugarBlock_if$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_sugarBlock_if", "symbols": [{"literal":"if"}, "_", {"literal":"("}, "e_sugarBlock_if_condition", {"literal":")"}, "_", "e_sugarBlock_content", "_", {"literal":"else"}, "e_sugarBlock_if$ebnf$1", "e_sugarBlock_if"], "postprocess": args => toASTNode(ast.SugarBlockIfExpression)([args[0], args[3], args[6], args.at(-1)])},
    {"name": "e_sugarBlock_if_condition", "symbols": ["e_main", "e_condition_extend", "e_main"], "postprocess": args => ({ left: args[0], right: args.at(-1) })},
    {"name": "e_sugarBlock_for", "symbols": [{"literal":"for"}, "_", {"literal":"("}, "e_sugarBlock_for_mapping", "_", {"literal":")"}, "_", "e_sugarBlock_content"], "postprocess": args => toASTNode(ast.SugarBlockForExpression)([args[0], args[3], args.at(-1)])},
    {"name": "e_sugarBlock_for_mapping$ebnf$1", "symbols": ["nonEmptySpace"]},
    {"name": "e_sugarBlock_for_mapping$ebnf$1", "symbols": ["e_sugarBlock_for_mapping$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_sugarBlock_for_mapping$ebnf$2", "symbols": ["nonEmptySpace"]},
    {"name": "e_sugarBlock_for_mapping$ebnf$2", "symbols": ["e_sugarBlock_for_mapping$ebnf$2", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_sugarBlock_for_mapping$ebnf$3", "symbols": ["nonEmptySpace"]},
    {"name": "e_sugarBlock_for_mapping$ebnf$3", "symbols": ["e_sugarBlock_for_mapping$ebnf$3", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_sugarBlock_for_mapping", "symbols": [{"literal":"infer"}, "e_sugarBlock_for_mapping$ebnf$1", "id", "e_sugarBlock_for_mapping$ebnf$2", {"literal":"in"}, "e_sugarBlock_for_mapping$ebnf$3", "e_main"], "postprocess": args => ({ name: args[2], source: args.at(-1) })},
    {"name": "e_sugarBlock_return$ebnf$1", "symbols": ["nonEmptySpace"]},
    {"name": "e_sugarBlock_return$ebnf$1", "symbols": ["e_sugarBlock_return$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_sugarBlock_return", "symbols": [{"literal":"return"}, "e_sugarBlock_return$ebnf$1", "e_main"], "postprocess": args => toASTNode(ast.SugarBlockReturnExpression)([args[0], args.at(-1)])},
    ...
    {"name": "e_object$ebnf$1$subexpression$2", "symbols": ["e_object_content", "_", "e_object_content_eof"]},
    {"name": "e_object$ebnf$1", "symbols": ["e_object$ebnf$1", "e_object$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "e_intersection_mode1$macrocall$1$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "e_intersection_mode1$macrocall$2"]},
    {"name": "e_intersection_mode1$macrocall$1$ebnf$1", "symbols": ["e_intersection_mode1$macrocall$1$ebnf$1", "e_intersection_mode1$macrocall$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_intersection_mode1$macrocall$1$ebnf$2", "symbols": [{"literal":","}], "postprocess": id},
    {"name": "e_intersection_mode1$macrocall$1$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "e_intersection_mode1$macrocall$1", "symbols": ["e_intersection_mode1$macrocall$2", "e_intersection_mode1$macrocall$1$ebnf$1", "e_intersection_mode1$macrocall$1$ebnf$2"], "postprocess": args => [args[0], ...args[1].map(x => x[3])]},
    {"name": "e_intersection_mode1", "symbols": [{"literal":"&"}, "_", {"literal":"["}, "_", "e_intersection_mode1$macrocall$1", "_", {"literal":"]"}], "postprocess": args => toASTNode(ast.IntersectionExpression)([args[0], args[4].map(id), args.at(-1)])},
    {"name": "e_intersection_mode2$ebnf$1$subexpression$1", "symbols": ["_", {"literal":"&"}, "_", "e_main"]},
    {"name": "e_intersection_mode2$ebnf$1", "symbols": ["e_intersection_mode2$ebnf$1$subexpression$1"]},
    {"name": "e_intersection_mode2$ebnf$1$subexpression$2", "symbols": ["_", {"literal":"&"}, "_", "e_main"]},
    {"name": "e_intersection_mode2$ebnf$1", "symbols": ["e_intersection_mode2$ebnf$1", "e_intersection_mode2$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "e_intersection_mode2", "symbols": ["e_main", "e_intersection_mode2$ebnf$1"], "postprocess":  (args, d, reject) => {
    ...
    {"name": "blockSeparator$ebnf$1", "symbols": ["blockSeparator$ebnf$1", {"literal":";"}], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "blockSeparator", "symbols": ["_", "blockSeparator$ebnf$1", "_"], "postprocess": n},
    ...
    {"name": "s_block", "symbols": ["s_block$ebnf$1"], "postprocess": args => args[0].map(id)},
    ...
    {"name": "s_declareFunction$ebnf$1", "symbols": ["s_declareFunction$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_declareFunction$ebnf$2", "symbols": ["nonEmptySpace"]},
    {"name": "s_declareFunction$ebnf$2", "symbols": ["s_declareFunction$ebnf$2", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_declareFunction", "symbols": [{"literal":"declare"}, "s_declareFunction$ebnf$1", {"literal":"function"}, "s_declareFunction$ebnf$2", "id"], "postprocess": args => toASTNode(ast.DeclareFunctionStatement)([args[0], args.at(-1)])},
    {"name": "s_declareFunction$ebnf$3", "symbols": ["nonEmptySpace"]},
    {"name": "s_declareFunction$ebnf$3", "symbols": ["s_declareFunction$ebnf$3", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_declareFunction$ebnf$4", "symbols": ["nonEmptySpace"]},
    {"name": "s_declareFunction$ebnf$4", "symbols": ["s_declareFunction$ebnf$4", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_declareFunction", "symbols": [{"literal":"declare"}, "s_declareFunction$ebnf$3", {"literal":"function"}, "s_declareFunction$ebnf$4", "id", "_", "e_function_normal"], "postprocess": args => toASTNode(ast.DeclareFunctionStatement)([args[0], args[4], args.at(-1)])},
    {"name": "s_enum$ebnf$1", "symbols": ["nonEmptySpace"]},
    {"name": "s_enum$ebnf$1", "symbols": ["s_enum$ebnf$1", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum", "symbols": [{"literal":"enum"}, "s_enum$ebnf$1", "id", "_", {"literal":"{"}, "_", {"literal":"}"}], "postprocess": args => toASTNode(ast.EnumStatement)([args[0], args[2], [], args.at(-1)])},
    {"name": "s_enum$ebnf$2", "symbols": ["nonEmptySpace"]},
    {"name": "s_enum$ebnf$2", "symbols": ["s_enum$ebnf$2", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum$ebnf$3", "symbols": ["nonEmptySpace"]},
    {"name": "s_enum$ebnf$3", "symbols": ["s_enum$ebnf$3", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum", "symbols": [{"literal":"const"}, "s_enum$ebnf$2", {"literal":"enum"}, "s_enum$ebnf$3", "id", "_", {"literal":"{"}, "_", {"literal":"}"}], "postprocess": args => toASTNode(ast.EnumStatement)([args[0], args[4], [], args.at(-1)])},
    {"name": "s_enum$ebnf$4", "symbols": ["nonEmptySpace"]},
    {"name": "s_enum$ebnf$4", "symbols": ["s_enum$ebnf$4", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum$ebnf$5$subexpression$1", "symbols": ["s_enum_member", "_", "s_enum_member_eof"]},
    {"name": "s_enum$ebnf$5", "symbols": ["s_enum$ebnf$5$subexpression$1"]},
    {"name": "s_enum$ebnf$5$subexpression$2", "symbols": ["s_enum_member", "_", "s_enum_member_eof"]},
    {"name": "s_enum$ebnf$5", "symbols": ["s_enum$ebnf$5", "s_enum$ebnf$5$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum", "symbols": [{"literal":"enum"}, "s_enum$ebnf$4", "id", "_", {"literal":"{"}, "_", "s_enum$ebnf$5", {"literal":"}"}], "postprocess": args => toASTNode(ast.EnumStatement)([args[0], args[2], args[6].map(id), args.at(-1)])},
    {"name": "s_enum$ebnf$6", "symbols": ["nonEmptySpace"]},
    {"name": "s_enum$ebnf$6", "symbols": ["s_enum$ebnf$6", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum$ebnf$7", "symbols": ["nonEmptySpace"]},
    {"name": "s_enum$ebnf$7", "symbols": ["s_enum$ebnf$7", "nonEmptySpace"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum$ebnf$8$subexpression$1", "symbols": ["s_enum_member", "_", "s_enum_member_eof"]},
    {"name": "s_enum$ebnf$8", "symbols": ["s_enum$ebnf$8$subexpression$1"]},
    {"name": "s_enum$ebnf$8$subexpression$2", "symbols": ["s_enum_member", "_", "s_enum_member_eof"]},
    {"name": "s_enum$ebnf$8", "symbols": ["s_enum$ebnf$8", "s_enum$ebnf$8$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "s_enum", "symbols": [{"literal":"const"}, "s_enum$ebnf$6", {"literal":"enum"}, "s_enum$ebnf$7", "id", "_", {"literal":"{"}, "_", "s_enum$ebnf$8", {"literal":"}"}], "postprocess": args => toASTNode(ast.EnumStatement)([args[0], args[4], args[8].map(id), args.at(-1)])},
    {"name": "s_enum_member$subexpression$1", "symbols": ["e_number"]},
    {"name": "s_enum_member$subexpression$1", "symbols": ["e_string"]},
    {"name": "s_enum_member", "symbols": ["id", "_", {"literal":"="}, "_", "s_enum_member$subexpression$1"], "postprocess": args => toASTNode(ast.EnumMemberExpression)([args[0], args.at(-1)[0]])},
    {"name": "s_enum_member", "symbols": ["id", "_"], "postprocess": args => toASTNode(ast.EnumMemberExpression)([args[0]])},
