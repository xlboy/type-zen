...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "e_main", "symbols": ["s_sugarBlock"], "postprocess": id},
    ...
    {"name": "s_sugarBlock_content", "symbols": [{"literal":"{"}, "_", "s_sugarBlock_content$ebnf$1", "_", {"literal":"}"}], "postprocess": args => toASTNode(ast.SugarBlockStatement)([args[0], args[2].map(id), args.at(-1)])},
    ...
    {"name": "s_if", "symbols": ["s_if_start"], "postprocess": id},
    {"name": "s_if_start", "symbols": [{"literal":"if"}, "_", {"literal":"("}, "s_if_condition", {"literal":")"}, "_", "s_sugarBlock_content"], "postprocess": args => toASTNode(ast.IfStatement)([args[0], args[3], args.at(-1)])},
